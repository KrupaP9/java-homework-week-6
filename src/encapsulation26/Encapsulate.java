...
public class Encapsulate {
    //private methods declared these can only be accessed by public methods of class
    private String name;
    private int rollNo;
    private int age;

    //get method for name to access provate variable name
    ...
    //get method for agetp access private variable age
    public int getAge(){
        return age;
    }
